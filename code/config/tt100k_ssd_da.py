...
lrDecayScheduler_epochs = [12, 16]  # List of epochs were decay is applied or None for all epochs
...
da_width_shift_range = 0.2  # Rnd horizontal shift
da_height_shift_range = 0.2  # Rnd vertical shift
