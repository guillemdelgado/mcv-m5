...
weights_file_pretrained      = 'home/master/mcv-m5/code/Experiments/TT100K_trafficSigns/vgg_baseline/weights.hdf5'            # Pretrained weights file name
...
checkpoint_monitor           = 'loss'           # Metric to monitor
