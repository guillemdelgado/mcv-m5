...
pretrained_weights_file                 = '/home/master/mcv-m5/code/Experiments/TT100K_detection/prova/weights.hdf5'  # Training weight file name
...
earlyStopping_monitor        = 'val_avg_recall'    # Metric to monitor
...
checkpoint_monitor           = 'val_avg_recall'            # Metric to monitor
...
da_channel_shift_range             = 0.4         # Channecf.l shifts
